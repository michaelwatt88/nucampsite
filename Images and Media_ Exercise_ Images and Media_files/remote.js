...
a&&g.Hm(e,a);b&&g.Im(e,b);c&&g.Jm(e,c);d&&(e.u=d);return e},d6=function(a,b){g.Go[a]=!0;
var c=g.Ao();c&&c.publish.apply(c,arguments);g.Go[a]=!1},e6=function(a){try{var b=(0,g.ky)(),c=(0,g.jy)();
...
this.w=b;this.G=c;this.D=d||1;this.B=45E3;this.A=new g.f_(this);this.u=new g.cl;this.u.setInterval(250)},Fqa=function(a,b,c){a.ci=1;
a.Rf=Y5(b.clone());a.rh=c;a.C=!0;Eqa(a,null)},B6=function(a,b,c,d,e){a.ci=1;
a.Rf=Y5(b.clone());a.rh=null;a.C=c;e&&(a.jz=!1);Eqa(a,d)},Eqa=function(a,b){a.Ji=(0,g.A)();
C6(a);a.xg=a.Rf.clone();Z5(a.xg,"t",a.D);a.Sk=0;a.uc=a.o.Vo(a.o.Hk()?b:null);0<a.Bp&&(a.Bn=new g.fl((0,g.x)(a.jA,a,a.uc),a.Bp));a.A.ga(a.uc,"readystatechange",a.DL);var c=a.Wg?g.Zb(a.Wg):{};a.rh?(a.eo="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.uc.send(a.xg,a.eo,a.rh,c)):(a.eo="GET",a.jz&&!g.Id&&(c.Connection="close"),a.uc.send(a.xg,a.eo,null,c));a.o.ne(1)},Iqa=function(a,b,c){for(var d=!0;!a.Jg&&a.Sk<c.length;){var e=Gqa(a,c);
if(e==D6){4==b&&(a.gg=4,E6(15),d=!1);break}else if(e==Hqa){a.gg=4;E6(16);d=!1;break}else F6(a,e)}4==b&&0==c.length&&(a.gg=1,E6(17),d=!1);a.oe=a.oe&&d;d||(G6(a),H6(a))},Gqa=function(a,b){var c=a.Sk,d=b.indexOf("\n",c);
if(-1==d)return D6;c=Number(b.substring(c,d));if(isNaN(c))return Hqa;d+=1;if(d+c>b.length)return D6;var e=b.substr(d,c);a.Sk=d+c;return e},Kqa=function(a,b){a.Ji=(0,g.A)();
...
I6[l]=k}e+=k}}d+='<script>document.domain="'+e+'"\x3c/script>'}c=g.Qc(g.pc("b/12014412"),d+"</body></html>");a.ue.open();a.ue.write(g.Lc(c));a.ue.close();a.ue.parentWindow.m=(0,g.x)(a.SK,a);a.ue.parentWindow.d=(0,g.x)(a.ry,a,!0);a.ue.parentWindow.rpcClose=(0,g.x)(a.ry,a,!1);c=a.ue.createElement("DIV");a.ue.parentWindow.document.body.appendChild(c);d=g.Bc(a.xg.toString());d=g.Xc(g.zc(d));d=g.Qc(g.pc("b/12014412"),'<iframe src="'+d+'"></iframe>');g.Rc(c,d);a.o.ne(1)},C6=function(a){a.Bs=(0,g.A)()+a.B;
Lqa(a,a.B)},Lqa=function(a,b){if(null!=a.Xi)throw Error("WatchDog timer not null");
a.Xi=J6((0,g.x)(a.aL,a),b)},K6=function(a){a.Xi&&(g.u.clearTimeout(a.Xi),a.Xi=null)},H6=function(a){a.o.kv()||a.Jg||a.o.sn(a)},G6=function(a){K6(a);
g.yi(a.Bn);a.Bn=null;a.u.stop();g.h_(a.A);if(a.uc){var b=a.uc;a.uc=null;b.abort();b.dispose()}a.ue&&(a.ue=null)},F6=function(a,b){try{a.o.ly(a,b),a.o.ne(4)}catch(c){}},Nqa=function(a,b,c,d,e){if(0==d)c(!1);
...
this.u=new y6},Pqa=function(a){var b=M6(a.o,a.gj,"/mail/images/cleardot.gif");
Y5(b);Nqa(b.toString(),5E3,(0,g.x)(a.AB,a),3,2E3);a.ne(1)},O6=function(a){var b=a.o.H;
if(null!=b)E6(5),b?(E6(11),N6(a.o,a,!1)):(E6(12),N6(a.o,a,!0));else if(a.xd=new A6(a,void 0,void 0,void 0),a.xd.Wg=a.zp,b=a.o,b=M6(b,b.Hk()?a.Ej:null,a.Ap),E6(5),!g.Gd||g.kd(10))Z5(b,"TYPE","xmlhttp"),B6(a.xd,b,!1,a.Ej,!1);else{Z5(b,"TYPE","html");var c=a.xd;a=!!a.Ej;c.ci=3;c.Rf=Y5(b.clone());Kqa(c,a)}},P6=function(a){g.sk.call(this);
...
if(3==a.o){var b=a.lk++,c=a.Vl.clone();X5(c,"SID",a.w);X5(c,"RID",b);X5(c,"TYPE","terminate");V6(a,c);b=new A6(a,a.w,b,void 0);b.ci=2;b.Rf=Y5(c.clone());b6(new Image,b.Rf.toString());b.Ji=(0,g.A)();C6(b)}bra(a)},dra=function(a){a.VB(1,0);
a.Vl=M6(a,null,a.yp);W6(a)},ara=function(a){a.Vf&&(a.Vf.abort(),a.Vf=null);
...
a.u.push(new Xqa(a.iH++,b));2!=a.o&&3!=a.o||W6(a)},W6=function(a){a.rd||a.cg||(a.cg=J6((0,g.x)(a.qy,a),0),a.Rh=0)},gra=function(a,b){if(1==a.o){if(!b){a.lk=Math.floor(1E5*Math.random());
var c=a.lk++,d=new A6(a,"",c,void 0);d.Wg=null;var e=Y6(a),f=a.Vl.clone();X5(f,"RID",c);X5(f,"CVER","1");V6(a,f);Fqa(d,f,e);a.rd=d;a.o=2}}else 3==a.o&&(b?fra(a,b):0==a.u.length||a.rd||fra(a))},fra=function(a,b){if(b)if(6<a.Kg){a.u=a.A.concat(a.u);
a.A.length=0;var c=a.lk-1;var d=Y6(a)}else c=b.G,d=b.rh;else c=a.lk++,d=Y6(a);var e=a.Vl.clone();X5(e,"SID",a.w);X5(e,"RID",c);X5(e,"AID",a.ri);V6(a,e);c=new A6(a,a.w,c,a.Rh+1);c.Wg=null;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.rd=c;Fqa(c,e,d)},V6=function(a,b){if(a.Pc){var c=a.Pc.Lu();
c&&g.Ib(c,function(d,e){X5(b,e,d)})}},Y6=function(a){var b=Math.min(a.u.length,1E3),c=["count="+b];
if(6<a.Kg&&0<b){var d=a.u[0].o;c.push("ofs="+d)}else d=0;for(var e=0;e<b;e++){var f=a.u[e].o,k=a.u[e].map;f=6>=a.Kg?e:f-d;try{g.Ib(k,function(l,m){c.push("req"+f+"_"+m+"="+encodeURIComponent(l))})}catch(l){c.push("req"+f+"_type="+encodeURIComponent("_badmap"))}}a.A=a.A.concat(a.u.splice(0,b));
return c.join("&")},hra=function(a){a.Qb||a.hf||(a.D=1,a.hf=J6((0,g.x)(a.py,a),0),a.Lh=0)},Z6=function(a){if(a.Qb||a.hf||3<=a.Lh)return!1;
a.D++;a.hf=J6((0,g.x)(a.py,a),ira(a,a.Lh));a.Lh++;return!0},N6=function(a,b,c){a.bo=c;
a.De=b.vf;a.C||dra(a)},X6=function(a){null!=a.Og&&(g.u.clearTimeout(a.Og),a.Og=null)},ira=function(a,b){var c=5E3+Math.floor(1E4*Math.random());
...
a.Pc&&a.Pc.Zt(b);bra(a);ara(a)},bra=function(a){a.o=0;
a.De=-1;if(a.Pc)if(0==a.A.length&&0==a.u.length)a.Pc.Po();else{g.db(a.A);var b=g.db(a.u);a.A.length=0;a.u.length=0;a.Pc.Po(b)}},M6=function(a,b,c){var d=g.Om(c);
if(""!=d.o)b&&g.Im(d,b+"."+d.o),g.Jm(d,d.B);else{var e=window.location;d=eqa(e.protocol,b?b+"."+e.hostname:e.hostname,+e.port,c)}a.rj&&g.Ib(a.rj,function(f,k){X5(d,k,f)});
X5(d,"VER",a.Kg);V6(a,d);return d},J6=function(a,b){if(!g.Ja(a))throw Error("Fn must not be null and must be a function");
...
secondTestResults:!a.o.bo,sessionId:a.o.w,arrayId:a.o.ri}},ora=function(a,b){a.G=b||0;
...
a.w=g.xo((0,g.x)(a.Fr,a),0<a.A&&a.A<(0,g.A)()?2E4:1E4)},r7=function(a){i7("OnlineScreenService",a)},Dra=function(a){var b={};
...
if(b){if(a.info("onConnectedScreenId_: Received screenId: "+b),!a.w||a.w.id!=b){var c=(0,g.x)(a.un,a),d=(0,g.x)(a.Kd,a);a.dv(b,c,d,5)}}else a.Kd(Error("Waiting for session status timed out."))},B7=function(a,b,c){y7.call(this,a,b,"DialSession");
this.A=this.G=null;this.J="";this.P=c;this.B=null;this.D=g.Ea;this.C=NaN;this.K=(0,g.x)(this.YM,this);this.o=g.Ea},Lra=function(a){a.o=a.H.pA(a.J,a.u.label,a.u.friendlyName,(0,g.x)(function(b){this.o=g.Ea;
...
this.o=g.xo((0,g.x)(this.si,this,null),150)},D7=function(a,b,c,d){g.P.call(this);
...
b.u),b.subscribe("sessionScreen",(0,g.x)(a.oy,a,b)),b.w?a.R("yt-remote-cast2-session-change",b.w):c&&a.o.si(null)):a.R("yt-remote-cast2-session-change",null))},Ora=function(a){var b=a.u.oA(),c=a.o&&a.o.u;
...
this.o=0;this.A=a;this.C=[];this.B=new lra;this.w=this.u=null;this.H=(0,g.x)(this.QH,this);this.D=(0,g.x)(this.pk,this);this.G=(0,g.x)(this.PH,this);this.J=(0,g.x)(this.cI,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.Es,this),$ra(this))):c=3;0!=c&&(b?this.Es(c):g.xo((0,g.x)(function(){this.Es(c)},this),0));
...
a.A.setPlayerContextData(X7(b));$ra(a)},Y7=function(a,b){a.w&&(a.w.removeUpdateListener(a.H),a.w.removeMediaListener(a.D),a.pk(null));
a.w=b;a.w&&(i7("CP","Setting cast session: "+a.w.sessionId),a.w.addUpdateListener(a.H),a.w.addMediaListener(a.D),a.w.media.length&&a.pk(a.w.media[0]))},bsa=function(a){var b=a.u.media,c=a.u.customData;
...
this.Ph(1)},a),2E4)},i8=function(a){g.zo(a.B);
...
b==(d7(a.o)&&isNaN(a.B))?b&&(h8(a,1),l8(a,"getSubtitlesTrack")):b?(a.bv()&&a.Pa.reset(),h8(a,1),l8(a,"getNowPlaying"),fsa(a)):a.Ph(1)},hsa=function(a,b){var c=b.params.videoId;
...
a.G=g.xo((0,g.x)(a.Ph,a,1),864E5)},l8=function(a,b,c){c?g8("Sending: action="+b+", params="+g.xj(c)):g8("Sending: action="+b);
...
this.B=a;this.u=b;this.w=new g.Q(this);g.H(this,this.w);this.w.M(b,"onCaptionsTrackListChanged",this.OI);this.w.M(b,"captionschanged",this.OH);this.w.M(b,"captionssettingschanged",this.Bz);this.w.M(b,"videoplayerreset",this.vn);this.w.M(b,"mdxautoplaycancel",this.zB);this.T=this.w.M(b,"onVolumeChange",this.Vx);this.G=!1;this.o=c;c.subscribe("proxyStateChange",this.ky,this);c.subscribe("remotePlayerChange",this.rk,this);c.subscribe("remoteQueueChange",this.vn,this);c.subscribe("autoplayUpNext",this.Lx,
this);c.subscribe("previousNextChange",this.hy,this);c.subscribe("nowAutoplaying",this.dy,this);c.subscribe("autoplayDismissed",this.Kx,this);this.suggestion=null;this.H=new g.Pt(64);this.A=new g.J(this.zz,500,this);g.H(this,this.A);this.C=new g.J(this.Az,1E3,this);g.H(this,this.C);this.K=new w6(this.vM,0,this);g.H(this,this.K);this.D={};this.U=new g.J(this.bA,1E3,this);g.H(this,this.U);this.J=new g.fl(this.iF,1E3,this);g.H(this,this.J);this.P=g.Ea;this.Bz();this.vn();this.rk()},H8=function(a,b){var c=
...
b&&(c={style:a.u.getSubtitlesUserSettings()},g.bc(c,b));a.o.oz(a.u.getVideoData(1).videoId,c);a.D=$7(a.o).o}},L8=function(a,b){var c=a.u.getPlaylist();
...
this.u={key:l6(),name:"This computer"};this.B=null;this.A=[];this.P=this.o=null;this.J=[this.u];this.w=this.u;this.D=new g.Pt(64);this.U=0;this.H=-1;this.C=null;if(!g.nz(this.player.O())){a=this.player;var b=g.gD(a);b&&(b=b.ck())&&(b=new O8(a,b),g.H(this,b));b=new N8(a);g.H(this,b);g.YK(a,b.element,4);this.C=new M8;g.H(this,this.C);g.YK(a,this.C.element,4);this.K=!!u8()}this.G=null},Q8=function(a){a.G&&(a.player.removeEventListener("presentingplayerstatechange",a.G),a.G=null)},Bsa=function(a,b,c){a.D=
c;
a.player.R("presentingplayerstatechange",new g.xD(c,b))},R8=function(a,b){if(b.key!=a.w.key)if(b.key==a.u.key)z8();
else{var c;(c=!g.R(a.player.O().experiments,"mdx_enable_privacy_disclosure_ui"))||(c=((c=g.po("PLAYER_CONFIG"))&&c.args&&void 0!==c.args.authuser?!0:!(!g.po("SESSION_INDEX")&&!g.po("LOGGED_IN")))||a.K||!a.C);if(c?0:a.player.O().bh()||"WEB_EMBEDDED_PLAYER"==a.player.O().deviceParams.c)g.Wt(g.FK(a.player))?a.player.pauseVideo():(a.G=(0,g.x)(a.qL,a),a.player.addEventListener("presentingplayerstatechange",a.G)),a.C&&a.C.w.show(),x8()||(E8=!0);a.w=b;var d=a.player.getPlaylistId();c=a.player.getVideoData(1);
...
y6.prototype.parse=function(a){return g.u.JSON.parse(a,void 0)};z6.prototype.o=null;z6.prototype.getOptions=function(){var a;(a=this.o)||(a={},Cqa(this)&&(a[0]=!0,a[1]=!0),a=this.o=a);return a};var S8;g.Pa(Bqa,z6);S8=new Bqa;g.h=A6.prototype;g.h.Wg=null;g.h.oe=!1;g.h.Xi=null;g.h.Bs=null;g.h.Ji=null;g.h.ci=null;g.h.Rf=null;g.h.xg=null;g.h.rh=null;g.h.uc=null;g.h.Sk=0;g.h.ue=null;g.h.eo=null;g.h.gg=null;g.h.Fj=-1;g.h.jz=!0;g.h.Jg=!1;g.h.Bp=0;g.h.Bn=null;var Hqa={},D6={};g.h=A6.prototype;g.h.setTimeout=function(a){this.B=a};
g.h.DL=function(a){a=a.target;var b=this.Bn;b&&3==R6(a)?b.lm():this.jA(a)};
g.h.jA=function(a){try{if(a==this.uc)a:{var b=R6(this.uc),c=this.uc.C,d=this.uc.getStatus();if(g.Gd&&!g.kd(10)||g.Id&&!g.jd("420+")){if(4>b)break a}else if(3>b||3==b&&!g.dg&&!T6(this.uc))break a;this.Jg||4!=b||7==c||(8==c||0>=d?this.o.ne(3):this.o.ne(2));K6(this);var e=this.uc.getStatus();this.Fj=e;var f=T6(this.uc);(this.oe=200==e)?(4==b&&G6(this),this.C?(Iqa(this,b,f),g.dg&&this.oe&&3==b&&(this.A.ga(this.u,"tick",this.wL),this.u.start())):F6(this,f),this.oe&&!this.Jg&&(4==b?this.o.sn(this):(this.oe=
...
g.h.wL=function(){var a=R6(this.uc),b=T6(this.uc);this.Sk<b.length&&(K6(this),Iqa(this,a,b),this.oe&&4!=a&&C6(this))};
g.h.SK=function(a){J6((0,g.x)(this.RK,this,a),0)};
g.h.RK=function(a){this.Jg||(K6(this),F6(this,a),C6(this))};
g.h.ry=function(a){J6((0,g.x)(this.QK,this,a),0)};
g.h.QK=function(a){this.Jg||(G6(this),this.oe=a,this.o.sn(this),this.o.ne(4))};
g.h.cancel=function(){this.Jg=!0;G6(this)};
g.h.aL=function(){this.Xi=null;var a=(0,g.A)();0<=a-this.Bs?(2!=this.ci&&this.o.ne(3),G6(this),this.gg=2,E6(18),H6(this)):Lqa(this,this.Bs-a)};
g.h.getLastError=function(){return this.gg};g.h=Oqa.prototype;g.h.zp=null;g.h.xd=null;g.h.Cn=!1;g.h.lv=null;g.h.Tl=null;g.h.cq=null;g.h.Ap=null;g.h.ae=null;g.h.vf=-1;g.h.Ej=null;g.h.gj=null;g.h.connect=function(a){this.Ap=a;a=M6(this.o,null,this.Ap);E6(3);this.lv=(0,g.A)();var b=this.o.G;null!=b?(this.Ej=b[0],(this.gj=b[1])?(this.ae=1,Pqa(this)):(this.ae=2,O6(this))):(Z5(a,"MODE","init"),this.xd=new A6(this,void 0,void 0,void 0),this.xd.Wg=this.zp,B6(this.xd,a,!1,null,!0),this.ae=0)};
g.h.AB=function(a){if(a)this.ae=2,O6(this);else{E6(4);var b=this.o;b.De=b.Vf.vf;$6(b,9)}a&&this.ne(2)};
g.h.Vo=function(a){return this.o.Vo(a)};
g.h.abort=function(){this.xd&&(this.xd.cancel(),this.xd=null);this.vf=-1};
g.h.kv=function(){return!1};
g.h.ly=function(a,b){this.vf=a.Fj;if(0==this.ae)if(b){try{var c=this.u.parse(b)}catch(d){c=this.o;c.De=this.vf;$6(c,2);return}this.Ej=c[0];this.gj=c[1]}else c=this.o,c.De=this.vf,$6(c,2);else if(2==this.ae)if(this.Cn)E6(7),this.cq=(0,g.A)();else if("11111"==b){if(E6(6),this.Cn=!0,this.Tl=(0,g.A)(),c=this.Tl-this.lv,!g.Gd||g.kd(10)||500>c)this.vf=200,this.xd.cancel(),E6(12),N6(this.o,this,!0)}else E6(8),this.Tl=this.cq=(0,g.A)(),this.Cn=!1};
g.h.sn=function(){this.vf=this.xd.Fj;if(this.xd.oe)0==this.ae?this.gj?(this.ae=1,Pqa(this)):(this.ae=2,O6(this)):2==this.ae&&((!g.Gd||g.kd(10)?!this.Cn:200>this.cq-this.Tl)?(E6(11),N6(this.o,this,!1)):(E6(12),N6(this.o,this,!0)));else{0==this.ae?E6(9):2==this.ae&&E6(10);var a=this.o;this.xd.getLastError();a.De=this.vf;$6(a,2)}};
...
this.aa&&(this.o.responseType=this.aa);"withCredentials"in this.o&&this.o.withCredentials!==this.V&&(this.o.withCredentials=this.V);try{Wqa(this),0<this.D&&(this.K=Qqa(this.o),c6(S6(this,"Will abort after "+this.D+"ms if incomplete, xhr2 "+this.K)),this.K?(this.o.timeout=this.D,this.o.ontimeout=(0,g.x)(this.qv,this)):this.J=g.dl(this.qv,this.D,this)),c6(S6(this,"Sending request")),this.G=!0,this.o.send(a),this.G=!1}catch(f){c6(S6(this,"Send error: "+f.message)),Tqa(this,f)}};
g.h.qv=function(){"undefined"!=typeof g.n_&&this.o&&(this.A="Timed out after "+this.D+"ms, aborting",this.C=8,S6(this,this.A),this.dispatchEvent("timeout"),this.abort(8))};
...
g.h.ov=function(){this.ha()||(this.da||this.G||this.B?Vqa(this):this.RJ())};
...
g.h.getLastError=function(){return"string"===typeof this.A?this.A:String(this.A)};g.h=U6.prototype;g.h.rj=null;g.h.rd=null;g.h.Qb=null;g.h.yp=null;g.h.Vl=null;g.h.Nt=null;g.h.mm=null;g.h.lk=0;g.h.iH=0;g.h.Pc=null;g.h.cg=null;g.h.hf=null;g.h.Og=null;g.h.Vf=null;g.h.bo=null;g.h.ri=-1;g.h.Vv=-1;g.h.De=-1;g.h.Rh=0;g.h.Lh=0;g.h.Kg=8;var a7=new g.sk;g.Pa(Yqa,g.Uj);g.Pa(Zqa,g.Uj);g.Pa($qa,g.Uj);g.h=U6.prototype;g.h.connect=function(a,b,c,d,e){E6(0);this.yp=b;this.rj=c||{};d&&void 0!==e&&(this.rj.OSID=d,this.rj.OAID=e);this.C?(J6((0,g.x)(this.hu,this,a),100),dra(this)):this.hu(a)};
g.h.hu=function(a){this.Vf=new Oqa(this);this.Vf.zp=null;this.Vf.u=this.B;this.Vf.connect(a)};
g.h.kv=function(){return 0==this.o};
g.h.qy=function(a){this.cg=null;gra(this,a)};
g.h.py=function(){this.hf=null;this.Qb=new A6(this,this.w,"rpc",this.D);this.Qb.Wg=null;this.Qb.Bp=0;var a=this.Nt.clone();X5(a,"RID","rpc");X5(a,"SID",this.w);X5(a,"CI",this.bo?"0":"1");X5(a,"AID",this.ri);V6(this,a);if(!g.Gd||g.kd(10))X5(a,"TYPE","xmlhttp"),B6(this.Qb,a,!0,this.mm,!1);else{X5(a,"TYPE","html");var b=this.Qb,c=!!this.mm;b.ci=3;b.Rf=Y5(a.clone());Kqa(b,c)}};
g.h.ly=function(a,b){if(0!=this.o&&(this.Qb==a||this.rd==a))if(this.De=a.Fj,this.rd==a&&3==this.o)if(7<this.Kg){try{var c=this.B.parse(b)}catch(f){c=null}if(g.Ha(c)&&3==c.length)if(0==c[0])a:{if(!this.hf){if(this.Qb)if(this.Qb.Ji+3E3<this.rd.Ji)X6(this),this.Qb.cancel(),this.Qb=null;else break a;Z6(this);E6(19)}}else this.Vv=c[1],0<this.Vv-this.ri&&37500>c[2]&&this.bo&&0==this.Lh&&!this.Og&&(this.Og=J6((0,g.x)(this.KH,this),6E3));else $6(this,11)}else b!=Dsa.UN.o&&$6(this,11);else if(this.Qb==a&&
X6(this),!g.ub(b)){c=this.B.parse(b);g.Ha(c);for(var d=0;d<c.length;d++){var e=c[d];this.ri=e[0];e=e[1];2==this.o?"c"==e[0]?(this.w=e[1],this.mm=e[2],e=e[3],null!=e?this.Kg=e:this.Kg=6,this.o=3,this.Pc&&this.Pc.cu(),this.Nt=M6(this,this.Hk()?this.mm:null,this.yp),hra(this)):"stop"==e[0]&&$6(this,7):3==this.o&&("stop"==e[0]?$6(this,7):"noop"!=e[0]&&this.Pc&&this.Pc.au(e),this.Lh=0)}}};
g.h.KH=function(){null!=this.Og&&(this.Og=null,this.Qb.cancel(),this.Qb=null,Z6(this),E6(20))};
g.h.sn=function(a){if(this.Qb==a){X6(this);this.Qb=null;var b=2}else if(this.rd==a)this.rd=null,b=1;else return;this.De=a.Fj;if(0!=this.o)if(a.oe)1==b?(b=(0,g.A)()-a.Ji,a7.dispatchEvent(new Zqa(a7,a.rh?a.rh.length:0,b,this.Rh)),W6(this),this.A.length=0):hra(this);else{var c=a.getLastError(),d;if(!(d=3==c||7==c||0==c&&0<this.De)){if(d=1==b)this.rd||this.cg||1==this.o||2<=this.Rh?d=!1:(this.cg=J6((0,g.x)(this.qy,this,a),ira(this,this.Rh)),this.Rh++,d=!0);d=!(d||2==b&&Z6(this))}if(d)switch(c){case 1:$6(this,
5);break;case 4:$6(this,10);break;case 3:$6(this,6);break;case 7:$6(this,12);break;default:$6(this,2)}}};
g.h.VB=function(a){if(!g.Xa(arguments,this.o))throw Error("Unexpected channel state: "+this.o);};
g.h.mM=function(a){a?E6(2):(E6(1),jra(this,8))};
g.h.Vo=function(a){if(a)throw Error("Can't create secondary domain capable XhrIo object.");a=new P6;a.V=!1;return a};
g.h.isActive=function(){return!!this.Pc&&this.Pc.isActive(this)};
g.h.ne=function(a){a7.dispatchEvent(new $qa(a7,a))};
g.h.Hk=function(){return!(!g.Gd||g.kd(10))};
g.h=kra.prototype;g.h.cu=function(){};
g.h.au=function(){};
g.h.Zt=function(){};
g.h.Po=function(){};
...
g.h.Ef=function(a){return this.w.Xg(a)};
...
g.h.cu=function(){this.u.reset();this.B=null;this.A=0;if(this.D.length){var a=this.D;this.D=[];for(var b=0,c=a.length;b<c;++b)era(this.o,a[b])}this.R("handlerOpened")};
g.h.Zt=function(a){var b=2==a&&401==this.o.De;4==a||b||this.u.start();this.R("handlerError",a)};
...
g.h.Lu=function(){var a={v:2};this.H&&(a.gsessionid=this.H);0!=this.A&&(a.ui=""+this.A);0!=this.G&&(a.ui=""+this.G);this.B&&g.bc(a,this.B);return a};
g.h.au=function(a){"S"==a[0]?this.H=a[1]:"gracefulReconnect"==a[0]?(this.u.start(),cra(this.o)):this.R("handlerMessage",new mra(a[0],a[1]))};
...
m7.prototype.info=function(a){i7(this.D,a)};g.r(n7,g.P);g.h=n7.prototype;g.h.start=function(){!this.o&&isNaN(this.Fa)&&this.nA()};
...
g.h.nA=function(){this.Fa=NaN;this.o=g.zp(f7(this.C,"/pairing/get_screen"),{method:"POST",sb:{pairing_code:this.B},timeout:5E3,onSuccess:(0,g.x)(this.RM,this),onError:(0,g.x)(this.QM,this),Ld:(0,g.x)(this.SM,this)})};
g.h.RM=function(a,b){this.o=null;var c=b.screen||{};c.dialId=this.w;c.name=this.A;this.R("pairingComplete",new g6(c))};
g.h.QM=function(a){this.o=null;a.status&&404==a.status?this.u>=Fsa.length?this.R("pairingFailed",Error("DIAL polling timed out")):(a=Fsa[this.u],this.Fa=g.xo((0,g.x)(this.nA,this),a),this.u++):this.R("pairingFailed",Error("Server error "+a.status))};
...
g.h.LC=function(a){i7(this.D,"Requesting lounge tokens failed: "+a)};g.r(s7,g.P);g.h=s7.prototype;g.h.start=function(){var a=parseInt(g.my("yt-remote-fast-check-period")||"0",10);(this.A=(0,g.A)()-144E5<a?0:a)?u7(this):(this.A=(0,g.A)()+3E5,g.ly("yt-remote-fast-check-period",this.A),this.Fr())};
...
g.h.Fr=function(){g.zo(this.w);this.w=NaN;this.u&&this.u.abort();var a=Dra(this);if(a6(a)){var b=f7(this.B,"/pairing/get_screen_availability");this.u=g7(this.B,b,{lounge_token:g.Pb(a).join(",")},(0,g.x)(this.nK,this,a),(0,g.x)(this.mK,this))}else t7(this,{}),u7(this)};
g.h.nK=function(a,b){this.u=null;var c=g.Pb(Dra(this));if(g.ob(c,g.Pb(a))){c=b.screens||[];for(var d={},e=0,f=c.length;e<f;++e)d[a[c[e].loungeToken]]="online"==c[e].status;t7(this,d);u7(this)}else this.Jb("Changing Screen set during request."),this.Fr()};
...
g.h.oA=function(){return(0,g.Td)(this.Hd(!0),function(a){return!!this.u.o[a.id]},this)};
g.h.pA=function(a,b,c,d,e){this.info("getDialScreenByPairingCode "+a+" / "+b);var f=new n7(this.C,a,b,c);f.subscribe("pairingComplete",(0,g.x)(function(k){g.yi(f);d(w7(this,k))},this));
...
g.h.Nr=g.Ea;g.h.Y=function(){this.info("disposeInternal");g.zo(this.A);this.A=0;this.o&&(this.o.removeUpdateListener(this.C),this.o.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.B));this.o=null;A7.wb.Y.call(this)};
...
g.h.dv=function(a,b,c,d){Gra(this.H,this.u.label,a,this.u.friendlyName,(0,g.x)(function(e){e?b(e):0<=d?(z7(this,"Screen "+a+" appears to be offline. "+d+" retries left."),g.xo((0,g.x)(this.dv,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
g.h.rA=function(){return this.o};
g.h.VM=function(a){this.ha()||a||(z7(this,"Cast session died."),this.Kd())};g.Pa(B7,y7);g.h=B7.prototype;g.h.Mr=function(a){this.A=a;this.A.addUpdateListener(this.K)};
g.h.si=function(a){this.B=a;this.D()};
...
g.h.Np=function(a){this.J=l6();if(this.B){var b=new chrome.cast.DialLaunchResponse(!0,Mra(this));a(b);Lra(this)}else this.D=(0,g.x)(function(){g.zo(this.C);this.D=g.Ea;this.C=NaN;var c=new chrome.cast.DialLaunchResponse(!0,Mra(this));a(c);Lra(this)},this),this.C=g.xo((0,g.x)(function(){this.D()},this),100)};
g.h.nD=function(a,b,c){Gra(this.H,this.G.receiver.label,a,this.u.friendlyName,(0,g.x)(function(d){d&&d.token?(this.un(d),b(new chrome.cast.DialLaunchResponse(!1))):this.Np(b,c)},this),(0,g.x)(function(d){z7(this,"Failed to get DIAL screen: "+d);
this.Np(b,c)},this))};g.Pa(C7,y7);C7.prototype.stop=function(){this.Kd()};
C7.prototype.Mr=g.Ea;C7.prototype.si=function(){g.zo(this.o);this.o=NaN;var a=n6(this.H.Hd(),this.u.label);a?this.un(a):this.Kd(Error("No such screen"))};
C7.prototype.Y=function(){g.zo(this.o);this.o=NaN;C7.wb.Y.call(this)};g.Pa(D7,g.P);g.h=D7.prototype;
g.h.init=function(a,b){chrome.cast.timeout.requestSession=3E4;var c=new chrome.cast.SessionRequest(this.D);this.G||(c.dialRequest=new chrome.cast.DialRequest("YouTube"));var d=chrome.cast.AutoJoinPolicy.TAB_AND_ORIGIN_SCOPED,e=a?chrome.cast.DefaultActionPolicy.CAST_THIS_TAB:chrome.cast.DefaultActionPolicy.CREATE_SESSION,f=(0,g.x)(this.WJ,this);c=new chrome.cast.ApiConfig(c,(0,g.x)(this.ny,this),f,d,e);c.customDialLaunchCallback=(0,g.x)(this.jI,this);chrome.cast.initialize(c,(0,g.x)(function(){this.ha()||
(chrome.cast.addReceiverActionListener(this.A),tra(),this.u.subscribe("onlineScreenChange",(0,g.x)(this.qA,this)),this.w=Ora(this),chrome.cast.setCustomReceivers(this.w,g.Ea,(0,g.x)(function(k){this.Jb("Failed to set initial custom receivers: "+g.xj(k))},this)),this.R("yt-remote-cast2-availability-change",F7(this)),b(!0))},this),(0,g.x)(function(k){this.Jb("Failed to initialize API: "+g.xj(k));
b(!1)},this))};
...
E7("setConnectedScreenStatus: new active receiver: "+d.friendlyName);G7(this,new C7(this.u,d),!0)}this.o.Nr(b)}else E7("setConnectedScreenStatus: no screen.")};
g.h.WL=function(a){this.ha()?this.Jb("Setting connection data on disposed cast v2"):this.o?this.o.si(a):this.Jb("Setting connection data without a session")};
...
g.h.requestSession=function(){chrome.cast.requestSession((0,g.x)(this.ny,this),(0,g.x)(this.tK,this))};
g.h.Y=function(){this.u.unsubscribe("onlineScreenChange",(0,g.x)(this.qA,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.A);g.ab(g.w("yt.mdx.remote.debug.handlers_")||[],qra);g.yi(this.o);D7.wb.Y.call(this)};
g.h.Jb=function(a){i7("Controller",a)};
g.h.oy=function(a,b){this.o==a&&(b||G7(this,null),this.R("yt-remote-cast2-session-change",b))};
...
this.R("yt-remote-cast2-session-change",this.o.w),Promise.resolve(new chrome.cast.DialLaunchResponse(!1));this.Jb('Changing CAST intent from "'+c.receiverType+'" to "dial" for '+b.friendlyName);G7(this,new B7(this.u,b,this.C))}b=this.o;b.G=a;return b.G.appState==chrome.cast.DialAppState.RUNNING?new Promise((0,g.x)(b.nD,b,(b.G.extraData||{}).screenId||null)):new Promise((0,g.x)(b.Np,b))};
g.h.ny=function(a){if(!this.ha()){E7("New cast session ID: "+a.sessionId);var b=a.receiver;if(b.receiverType!=chrome.cast.ReceiverType.CUSTOM){if(!this.o)if(b.receiverType==chrome.cast.ReceiverType.CAST)E7("Got resumed cast session before resumed mdx connection."),b.friendlyName=chrome.cast.unescape(b.friendlyName),G7(this,new A7(this.u,b),!0);else{this.Jb("Got non-cast session without previous mdx receiver event, or mdx resume.");return}var c=this.o.u,d=n6(this.u.Hd(),c.label);d&&h6(d,b.label)&&
c.receiverType!=chrome.cast.ReceiverType.CAST&&b.receiverType==chrome.cast.ReceiverType.CAST&&(E7("onSessionEstablished_: manual to cast session change "+b.friendlyName),g.yi(this.o),this.o=new A7(this.u,b),this.o.subscribe("sessionScreen",(0,g.x)(this.oy,this,this.o)),this.o.si(null));this.o.Mr(a)}}};
g.h.WM=function(){return this.o?this.o.rA():null};
...
g.h.qA=function(){this.ha()||(this.w=Ora(this),E7("Updating custom receivers: "+g.xj(this.w)),chrome.cast.setCustomReceivers(this.w,g.Ea,(0,g.x)(function(){this.Jb("Failed to set custom receivers.")},this)),this.R("yt-remote-cast2-availability-change",F7(this)))};
...
g.h.mA=function(a,b){if(1==this.o){if(a&&b){var c=$7(this);W7(c,a,b);b8(this,c)}d8(this,"previous")}else a8(this,g.Na(this.mA,a,b))};
...
g.h.Es=function(a){if((a!=this.o||2==a)&&3!=this.o&&0!=a){var b=this.o;this.o=a;this.R("proxyStateChange",b,a);if(1==a)for(;!this.B.isEmpty();)b=a=this.B,g.Ya(b.o)&&(b.o=b.u,b.o.reverse(),b.u=[]),a.o.pop().apply(this);else 3==a&&this.dispose()}};
g.h.PJ=function(a,b){this.R(a,b)};
g.h.QH=function(a){if(!a)this.pk(null),Y7(this,null);else if(this.w.receiver.volume){a=this.w.receiver.volume;var b=$7(this),c=Math.round(100*a.level||0);if(b.volume!=c||b.muted!=a.muted)i7("CP","Cast volume update: "+a.level+(a.muted?" muted":"")),b.volume=c,b.muted=!!a.muted,b8(this,b)}};
g.h.pk=function(a){i7("CP","Cast media: "+!!a);this.u&&this.u.removeUpdateListener(this.G);if(this.u=a)this.u.addUpdateListener(this.G),bsa(this),this.R("remotePlayerChange")};
g.h.PH=function(a){a?(bsa(this),this.R("remotePlayerChange")):this.pk(null)};
...
g.h.FC=function(){this.Ph(2)};
g.h.UH=function(){g8("Channel opened");this.K&&(this.K=!1,j8(this),this.J=g.xo((0,g.x)(function(){g8("Timing out waiting for a screen.");this.Ph(1)},this),15E3));
sqa(nra(this.o),this.P)};
g.h.RH=function(){g8("Channel closed");isNaN(this.B)?s6(!0):s6();this.dispose()};
g.h.SH=function(a){s6();isNaN(this.zj())?(g8("Channel error: "+a+" without reconnection"),this.dispose()):(this.K=!0,g8("Channel error: "+a+" with reconnection in "+this.zj()+" ms"),h8(this,2))};
...
g.h.uC=function(){var a=3;this.ha()||(a=0,isNaN(this.zj())?d7(this.o)&&isNaN(this.B)&&(a=1):a=2);return a};
g.h.Ph=function(a){g8("Disconnecting with "+a);i8(this);this.R("beforeDisconnect",a);1==a&&s6();ora(this.o,a);this.dispose()};
...
g.h.bv=function(){var a=this.o.C.id,b=g.Ua(this.u,function(c){return"REMOTE_CONTROL"==c.type&&c.id!=a});
return b?b.id:""};
g.h.zj=function(){var a=this.o;return a.u.isActive()?a.u.u-(0,g.A)():NaN};
g.h.iC=function(){return this.A||"UNSUPPORTED"};
g.h.jC=function(){return this.C||""};
g.h.PM=function(){if(!isNaN(this.zj())){var a=this.o.u;g.$m(a.o);a.start()}};
g.h.SL=function(a,b){l8(this,a,b);fsa(this)};
f8.prototype.subscribe=f8.prototype.subscribe;f8.prototype.unsubscribeByKey=f8.prototype.Ef;f8.prototype.getProxyState=f8.prototype.uC;f8.prototype.disconnect=f8.prototype.Ph;f8.prototype.getPlayerContextData=f8.prototype.tC;f8.prototype.setPlayerContextData=f8.prototype.XL;f8.prototype.getOtherConnectedRemoteId=f8.prototype.bv;f8.prototype.getReconnectTimeout=f8.prototype.zj;f8.prototype.getAutoplayMode=f8.prototype.iC;f8.prototype.getAutoplayVideoId=f8.prototype.jC;f8.prototype.reconnect=f8.prototype.PM;
...
g.h.Yn=function(a,b,c,d){this.Rc.$_un(a,b,c,d)};
...
v7.prototype.$_st=v7.prototype.start;v7.prototype.$_gspc=v7.prototype.UM;v7.prototype.$_gsppc=v7.prototype.pA;v7.prototype.$_c=v7.prototype.contains;v7.prototype.$_g=v7.prototype.get;v7.prototype.$_a=v7.prototype.add;v7.prototype.$_un=v7.prototype.Yn;v7.prototype.$_r=v7.prototype.remove;v7.prototype.$_gs=v7.prototype.Hd;v7.prototype.$_gos=v7.prototype.oA;v7.prototype.$_s=v7.prototype.subscribe;v7.prototype.$_ubk=v7.prototype.Ef;var F8=null,E8=!1,n8=null,o8=null,D8=null,s8=[];g.r(G8,g.E);g.h=G8.prototype;
g.h.Y=function(){g.E.prototype.Y.call(this);this.A.stop();this.C.stop();this.K.stop();this.P();this.o.unsubscribe("proxyStateChange",this.ky,this);this.o.unsubscribe("remotePlayerChange",this.rk,this);this.o.unsubscribe("remoteQueueChange",this.vn,this);this.o.unsubscribe("autoplayUpNext",this.Lx,this);this.o.unsubscribe("previousNextChange",this.hy,this);this.o.unsubscribe("nowAutoplaying",this.dy,this);this.o.unsubscribe("autoplayDismissed",this.Kx,this);this.o=this.B=null};
g.h.Hw=function(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(2!=this.o.o)if(J8(this)){if(!$7(this.o).isAdPlaying()||"control_seek"!=a)switch(a){case "control_toggle_play_pause":1==$7(this.o).playerState?this.o.pause():this.o.play();break;case "control_play":this.o.play();break;case "control_pause":this.o.pause();break;case "control_seek":this.J.lm(c[0],c[1]);break;case "control_subtitles_set_track":K8(this,c[0]);break;case "control_set_audio_track":c=c[0],J8(this)&&this.o.setAudioTrack(this.u.getVideoData(1).videoId,
...
g.h.vM=function(a){this.Hw("control_subtitles_set_track",g.Wb(a)?null:a)};
g.h.Bz=function(){var a=this.u.getOption("captions","track");g.Wb(a)||K8(this,a)};
g.h.Vx=function(a){if(J8(this)){this.o.unsubscribe("remotePlayerChange",this.rk,this);var b=Math.round(a.volume);a=!!a.muted;var c=$7(this.o);if(b!=c.volume||a!=c.muted)this.o.setVolume(b,a),this.U.start();this.o.subscribe("remotePlayerChange",this.rk,this)}};
g.h.OI=function(){g.Wb(this.D)||Asa(this,this.D);this.G=!1};
g.h.ky=function(a,b){this.C.stop();2==b&&this.Az()};
g.h.rk=function(){if(J8(this)){this.A.stop();var a=$7(this.o);switch(a.playerState){case 1080:case 1081:case 1084:case 1085:this.B.H=1;break;case 1082:case 1083:this.B.H=0;break;default:this.B.H=-1}switch(a.playerState){case 1081:case 1:I8(this,new g.Pt(8));this.zz();break;case 1085:case 3:I8(this,new g.Pt(9));break;case 1083:case 0:I8(this,new g.Pt(2));this.J.stop();H8(this,this.u.getVideoData().lengthSeconds);break;case 1084:I8(this,new g.Pt(4));break;case 2:I8(this,new g.Pt(4));H8(this,V7(a));
break;case -1:I8(this,new g.Pt(64));break;case -1E3:I8(this,new g.Pt(128,{errorCode:"mdx.remoteerror",errorMessage:"This video is not available for remote playback."}))}a=$7(this.o).o;var b=this.D;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.D=a,Asa(this,a));a=$7(this.o);-1==a.volume||Math.round(this.u.getVolume())==a.volume&&this.u.isMuted()==a.muted||this.U.isActive()||this.bA()}else zsa(this)};
g.h.hy=function(){this.u.R("mdxpreviousnextchange")};
g.h.vn=function(){J8(this)||zsa(this)};
g.h.zB=function(){this.o.ou()};
g.h.Lx=function(a){a&&!g.R(this.u.O().experiments,"disable_legacy_desktop_remote_queue")&&(a=g.zp("/watch_queue_ajax",{method:"GET",od:{action_get_watch_queue_item:1,video_id:a},onSuccess:(0,g.x)(this.UK,this)}))&&(this.P=(0,g.x)(a.abort,a))};
...
g.h.dy=function(a){isNaN(a)||this.u.R("mdxnowautoplaying",a)};
g.h.Kx=function(){this.u.R("mdxautoplaycanceled")};
g.h.iF=function(a,b){-1==$7(this.o).playerState?L8(this,a):b&&this.o.seekTo(a)};
g.h.bA=function(){if(J8(this)){var a=$7(this.o);this.w.Ta(this.T);a.muted?this.u.mute():this.u.unMute();this.u.setVolume(a.volume);this.T=this.w.M(this.u,"onVolumeChange",this.Vx)}};
g.h.zz=function(){this.A.stop();if(!this.o.ha()){var a=$7(this.o);1==a.playerState&&I8(this,new g.Pt(8));H8(this,V7(a));this.A.start()}};
g.h.Az=function(){this.C.stop();this.A.stop();var a=this.o.A.getReconnectTimeout();2==this.o.o&&!isNaN(a)&&this.C.start()};g.r(M8,g.W);M8.prototype.A=function(){d6("mdx-privacy-popup-cancel");this.w.hide()};
...
g.h.create=function(){tsa(g.ez(this.player.O()));this.A.push(g.Io("yt-remote-before-disconnect",this.LH,this));this.A.push(g.Io("yt-remote-connection-change",this.XJ,this));this.A.push(g.Io("yt-remote-receiver-availability-change",this.iy,this));this.A.push(g.Io("yt-remote-auto-connect",this.VJ,this));this.A.push(g.Io("yt-remote-receiver-resumed",this.UJ,this));this.A.push(g.Io("mdx-privacy-popup-confirm",this.zL,this));this.A.push(g.Io("mdx-privacy-popup-cancel",this.yL,this));this.iy()};
...
g.h.ak=function(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];this.loaded&&this.B.Hw.apply(this.B,[a].concat(g.ea(c)))};
...
g.h.WE=function(){this.o&&this.o.mA()};
...
g.h.iy=function(){this.J=[this.u].concat(vsa());var a=y8()||this.u;R8(this,a);this.player.ka("onMdxReceiversChange")};
